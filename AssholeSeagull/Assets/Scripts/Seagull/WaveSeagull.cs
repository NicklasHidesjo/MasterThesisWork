...
public class WaveSeagull : MonoBehaviour
{
	...
	[SerializeField] private int shout = -10;
	...
	// used for recognition if shouting
	...
	private bool IsShouting()
	{
		...
		if (voiceVolume >= shout)
		{
			Debug.Log("I am shouting");
		}
		else
		{
			Debug.Log("I am not shouting");
		}

		return voiceVolume >= shout;
	}
